		...
		<section id="process" className="py-24 bg-zinc-900/50 border-y border-white/5">
			<div className="max-w-7xl mx-auto px-4">
				<motion.h2
					...
					className="text-3xl font-semibold text-white text-center mb-16 uppercase tracking-widest"
				>
					Как работим
				</motion.h2>
					...
					{steps.map((step, i) => (
						...
						>
							<motion.div
								...
								className="w-16 h-16 rounded-2xl bg-zinc-950 border border-zinc-800 flex items-center justify-center text-xl font-bold text-white shadow-lg group-hover:border-accent-500/50 group-hover:text-accent-500 transition-all shrink-0"
							>
								{step.id}
							</motion.div>
							<div>
